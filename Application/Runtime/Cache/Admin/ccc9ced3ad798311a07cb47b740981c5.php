          ...
          <form class="form-horizontal" id="singcms-form">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control"  id="editor-item" name="id">
                  <?php if(is_array($webSiteMenu)): foreach($webSiteMenu as $key=>$menu): ?><option value="<?php echo ($menu["content_id"]); ?>" 
                    <?php if($menu["content_id"] == $Content['content_id']): ?>selected="selected"<?php endif; ?>><?php echo ($menu["content_name"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5" id="inputPassword3">
                <textarea class="input js-editor" id="editor_singcms" rows="20" name="content" ><?php echo ($Content["content"]); ?></textarea>
              </div>
            </div>
