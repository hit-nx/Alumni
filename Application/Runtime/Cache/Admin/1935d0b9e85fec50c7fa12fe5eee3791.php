            ...
            <form id="singcms-listorder">
              <table class="table table-bordered table-hover singcms-table" >
                ...
                <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <th><?php echo ($menu["amount"]); ?></th>
                    <th><?php echo ($menu["date"]); ?></th>
                    <th><span class="sing_cursor glyphicon glyphicon-edit" aria-hidden="true" id="singcms-edit" attr-id="<?php echo ($menu["donationid"]); ?>" ></span>
                      <a href="javascript:void(0)" id="singcms-delete"  attr-id="<?php echo ($menu["donationid"]); ?>"  attr-message="删除">
...
<script>
  ...
  $("#page").paging({
    ...
    callback: function(num) {
      window.location.href = '/admin.php?c=donation&p=' + num;
    }
  })
