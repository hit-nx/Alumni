        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              ...
              <a href="/admin.php?c=alumnis">校友会管理</a>
            </li>
            <li class="active">
        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input value="<?php echo ($alumni["title"]); ?>" type="text" name="title" class="form-control" id="inputname" placeholder="请填写标题">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <textarea class="input js-editor" id="editor_singcms" name="content" rows="20" ><?php echo ($alumni["content"]); ?></textarea>
              </div>
            </div>

            <input type="hidden" name="alumnis_id" value="<?php echo ($alumni["alumnis_id"]); ?>"/>
...
<script>
  var SCOPE = {
    'save_url' : '/admin.php?c=alumnis&a=add',
    'jump_url' : '/admin.php?c=alumnis',
...
<script>
  var thumb = "<?php echo ($alumni["thumb"]); ?>";
  if(thumb) {
