        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input value="<?php echo ($title); ?>" type="text" name="title" class="form-control" id="inputname" placeholder="请填写通讯录标题">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input value="<?php echo ($picture_url); ?>" accept="image/*" name="picture_url" type="file" multiple="true">
              </div>
            </div>


            <div class="form-group">
              <label for="inputname1" class="col-sm-2 control-label">通讯录:</label>
              <div class="col-sm-5">
                <input value="<?php echo ($path); ?>" name="path" type="file" multiple="true" >
              </div>
            </div>

			<input type="hidden" name="periodicalid" value="<?php echo ($periodicalId); ?>"/>
