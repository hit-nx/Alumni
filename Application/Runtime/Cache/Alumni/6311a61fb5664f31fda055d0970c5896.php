...
<table class="form" cellspacing="0" cellpadding="0">
    ...
    <?php if(is_array($getEnterpriseList)): foreach($getEnterpriseList as $key=>$getEnterpriseList): ?><tr class="tr1">
            <td><a href="<?php echo ($getEnterpriseList["enterprise_url"]); ?>" target="_blank"><?php echo ($getEnterpriseList["name"]); ?></a></td>
