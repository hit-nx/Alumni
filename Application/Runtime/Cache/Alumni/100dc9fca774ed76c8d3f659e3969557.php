...
<!-- 	<th class="thleft">组织名称</th>
	...
	<?php if(is_array($getCommunicationList)): foreach($getCommunicationList as $key=>$getCommunicationListItems): ?><tr class="tr1">
			<td><a href="/index.php?c=address&periodicalid=<?php echo ($getCommunicationListItems["periodicalid"]); ?>" target="_blank"><?php echo ($getCommunicationListItems["title"]); ?></a></td>
