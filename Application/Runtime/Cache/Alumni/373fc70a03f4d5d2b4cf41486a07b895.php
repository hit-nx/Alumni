...
<html>
	...
	<body>
		...
		<div>
			<ul class="class">
				<li <?php echo getChooseByContent(1)?>><a href="/index.php?c=organization&contentid=1">校友会简介</a></li>
				<li <?php echo getChooseByContent(2)?>><a href="/index.php?c=organization&contentid=2">组织机构</a></li>
				<li <?php echo getChooseByContent(3)?>><a href="/index.php?c=organization&contentid=3">规章制度</a></li>
				<li <?php echo getChooseByContent(4)?>><a href="/index.php?c=organization&contentid=4">校友创业导师</a></li>
				<li><a href="/index.php?c=organization&a=organizationList">地方校友组织</a></li>
			</ul>			
		</div>
