	...
	<body>
		...
		<div>
			<ul class="class">
				...
				<li><a href="/index.php?c=organization&contentid=3">规章制度</a></li>
				<li><a href="/index.php?c=organization&contentid=4">校友创业导师</a></li>
				<li class="active"><a href="/index.php?c=organization&a=organizationList">地方校友组织</a></li>
			</ul>			
		</div>
...
<!-- 		<th class="thleft">组织名称</th>
	...
	<?php if(is_array($otherOrganizations)): foreach($otherOrganizations as $key=>$otherOrganizationsItems): ?><tr class="tr1">
			<td><a href="/index.php?c=organization&a=otherOrganizationInfo&alumnis_id=<?php echo ($otherOrganizationsItems["alumnis_id"]); ?>"><?php echo ($otherOrganizationsItems["title"]); ?></a></td>
